...
public class ExplosionsTest extends SimpleApplication {

	public static void main(String[] args) {
		ExplosionsTest app = new ExplosionsTest();
	...
	public void simpleInitApp() {
		...
		stateManager.attach(new StExplosions(rootNode));

		stateManager.attach(new StPicking());
	}
