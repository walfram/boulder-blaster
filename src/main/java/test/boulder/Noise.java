...
public class Noise {
	...
	final int RandomSize = 256;
	final double Sqrt3 = 1.7320508075688772935;
	final double Sqrt5 = 2.2360679774997896964;
	int[] _random;
	...
	final double G22 = G2 * 2.0 - 1;

	final double F3 = 1.0 / 3.0;
	final double G3 = 1.0 / 6.0;

	final double F4 = (Sqrt5 - 1.0) / 4.0;
	final double G4 = (5.0 - Sqrt5) / 20.0;
	final double G42 = G4 * 2.0;
	final double G43 = G4 * 3.0;
	final double G44 = G4 * 4.0 - 1.0;
	...
	static byte[] UnpackLittleUint32(int value, byte[] buffer) {
		if (buffer.length < 4)
